  ...
  return (
    <div className="pt-16 min-h-screen">
      <div className="px-6 py-8 max-w-4xl mx-auto">
        ...
        >
          <img src={thangka.image} alt={thangka.name} className="w-full object-contain" />
        </motion.div>
        ...
        {zoomed && (
          ...
          >
            <img src={thangka.image} alt={thangka.name} className="max-w-full max-h-full object-contain" />
          </div>
        )}

        <div className="text-center mb-10">
          <h1 className="font-display text-2xl md:text-3xl font-semibold text-foreground mb-1">{thangka.nameCn}</h1>
          ...
          <div className="grid grid-cols-2 md:grid-cols-4 gap-4 max-w-lg mx-auto text-sm">
            <div><span className="text-muted-foreground">佛像</span><p className="text-foreground">{thangka.deityCn}</p></div>
            <div><span className="text-muted-foreground">类型</span><p className="text-foreground">{thangka.typeCn}</p></div>
            <div><span className="text-muted-foreground">尺寸</span><p className="text-foreground">{thangka.size}</p></div>
            <div><span className="text-muted-foreground">年份</span><p className="text-foreground">{thangka.year}</p></div>
          </div>
        </div>
